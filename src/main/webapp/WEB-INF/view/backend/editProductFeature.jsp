...
<script src="scripts/backend/editProductFeature.js"></script>

<div class="panel panel-default">
    <div class="panel-heading">
    <p class="panel-title">产品亮点管理</p>
    </div>
    <div class="panel-body">
        ...
        <a href="admin/productFeature"><button class="btn btn-primary " >返回</button></a>
