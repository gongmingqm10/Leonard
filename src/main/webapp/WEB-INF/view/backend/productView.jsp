<%@ include file="admin.jsp" %>
 ...
 <script type="text/javascript" src="scripts/backend/productNews.js"></script>
              ...
              <div class="panel-heading">
                <h3 class="panel-title">产品视觉效果管理</h3>
              </div>
                    ...
                    <table class="table table-bordered">
                       <thead >
                          <tr>
                             ...
                             <th class="text-center">产品视觉效果</th>
                       ...
                       <tbody>
                          <c:forEach var="productRE" items="${productREs}" varStatus="row">
                              <tr>
                                  ...
                                  <td class="productNews"><c:out value="${productRE.productView}"/></td>
                                  <td class="action">
                                    <a href="admin/productView/editView/${productRE.id}"><button type="button" class="btn btn-default" >编辑</button></a>
                                  </td>
                              </tr>
                          </c:forEach>
                       </tbody>
